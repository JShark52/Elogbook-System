...
<head>
    ...
    <title>ELogbook System | Borrowed Item Details</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Borrowed Item Details</h4>
...
<div class="form-group">
<label>Item Borrowed Date :</label>
<?php echo htmlentities($result->IssuesDate);?>
</div>


<div class="form-group">
<label>Item Returned Date :</label>
...
<button type="submit" name="return" id="submit" class="btn btn-info">Return Item </button>
