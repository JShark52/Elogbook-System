...
<head>
    ...
    <title>ELogbook System | Borrow Item</title>
...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Borrow a New Item</h4>
...
<div class="form-group">
<label>Serial Number or Item Name<span style="color:red;">*</span></label>
...
<button type="submit" name="issue" id="submit" class="btn btn-info">Borrow Item </button>
